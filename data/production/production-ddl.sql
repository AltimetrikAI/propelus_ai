...
-- Status: Production-ready with all migrations (001-025) applied
-- Includes: confidence column in silver_mapping_taxonomies
...
CREATE TABLE IF NOT EXISTS silver_taxonomies (
    taxonomy_id BIGINT GENERATED BY DEFAULT AS IDENTITY,
    customer_id BIGINT,
    name VARCHAR(200),
    type VARCHAR(10),
    status VARCHAR(10),
